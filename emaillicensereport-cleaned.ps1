...
$customerDefaultDomainName = "DEFAULTDOMAINNAME"
######### Tenant parameters #########
...
$EmailCred = New-Object System.Management.Automation.PSCredential -ArgumentList ($emailusername, $emailpassword)

$From = "FROMEMAILHERE"
$To = "TOEMAILHERE"
$Subject = "EMAILSUBJECT"
$Body = "<img src='YOURCOMPANYLOGOURL' width='236' height='79'><br><br>"
$Body += "<h2>Office 365 user license report</h2><br>"
######### Email SMTP server settings #########
...
Connect-MsolService -AdGraphAccessToken $aadGraphToken.AccessToken -MsGraphAccessToken $graphToken.AccessToken
    ...
    write-host "Collecting data for $($customerDefaultDomainName)" -ForegroundColor Green
  ...
  $Body += $UserObj | Where-Object { $_.'Licenses Assigned' -ne ""} | ConvertTo-Html
  Send-MailMessage -From $From -to $To -Subject $Subject -Body $Body -BodyAsHtml -SmtpServer $SMTPServer -Port $SMTPPort -UseSsl -Credential $EmailCred
